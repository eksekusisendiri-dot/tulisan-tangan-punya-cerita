    ...
    <Layout>
      ...
      {state === AppState.CHOICE && (
        <div className="max-w-2xl mx-auto py-12 animate-fadeIn">
          ...
          {/* Marketing Hook */}
            <div className="mt-8 mb-8 bg-gradient-to-r from-indigo-50 to-white border border-indigo-100 rounded-2xl p-6 shadow-sm inline-block transform hover:scale-[1.02] transition-transform duration-300">
                <p className="text-indigo-900 text-base leading-relaxed">
                   ...
                   <span className="font-bold text-red-600">PROMO AWAL TAHUN.</span>{" "}
                    Dapatkan token aksesnya hanya seharga{" "} 
                   <span className="font-black text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded">Rp 30.000-an (tiga puluh ribuan)</span>.
             ...
             <div className="flex">
                ...
                <div className="ml-3">
                    ...
                    <p className="text-xs text-amber-600 mt-1">
                        Pastikan Anda sudah memiliki <b>foto tulisan tangan yang jelas Maksimal Ukuran 1 MB</b> di galeri HP/Laptop Anda sebelum melanjutkan.
                    </p>
